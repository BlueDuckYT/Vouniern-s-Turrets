...
@OnlyIn(Dist.CLIENT)
public class LaserShotRenderer<T extends LaserProjectile> extends EntityRenderer<T> {
    public LaserShotRenderer(EntityRendererProvider.Context p_173917_) {
        super(p_173917_);
    }
...
//        }
    ...
    public ResourceLocation getTextureLocation(T p_114482_) {
        return new ResourceLocation(VouniernTurrets.MODID, "textures/entity/laser_shot.png");
    }

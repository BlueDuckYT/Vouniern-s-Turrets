...
import blueduck.vounierns_turrets.client.model.BasicTurretT3Model;
...
public class BasicTurretT3Renderer extends GeoEntityRenderer<BasicTurret> {
    public BasicTurretT3Renderer(EntityRendererProvider.Context renderManager, AnimatedGeoModel<BasicTurret> modelProvider) {
        super(renderManager, modelProvider);
        this.shadowRadius = 0.4f;
    }
    public BasicTurretT3Renderer(EntityRendererProvider.Context renderManager) {
        super(renderManager, new BasicTurretT3Model());
        this.shadowRadius = 0.4f;
    }
    ...
    public RenderType getRenderType(BasicTurret animatable, float partialTick, PoseStack poseStack, @Nullable MultiBufferSource bufferSource, @Nullable VertexConsumer buffer, int packedLight, ResourceLocation texture) {
        return RenderType.entityTranslucent(new ResourceLocation(VouniernTurrets.MODID, "textures/entity/stone_turret_tier_3.png"));
    }
}

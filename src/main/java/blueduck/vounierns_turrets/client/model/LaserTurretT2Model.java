...
public class LaserTurretT2Model extends AnimatedGeoModel<LaserTurret> {
    @Override
    public ResourceLocation getModelResource(LaserTurret object) {
        return new ResourceLocation(VouniernTurrets.MODID, "geo/laser_turret_tier_2.geo.json");
    }
